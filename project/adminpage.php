    ...
    <nav id="navBar" class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <form class="form-inline press">
                <button class="btn btn-outline-success" type="button"><a href="index.html">Log in</a></button>
            </form>
        </div>
    </nav>
                                ...
                                foreach ($users as $user) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <button type="button" class="btn btn-info" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">show</button> -->
                        ...
                        <table class="table table-bordered table-striped mb-0" id="myTable2">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $user['cnic']; ?></td>
                                    <td>
                                        <button type="button" class="btn btn-success" onclick="accept00()">Success</button>

                                        <button type="button" class="btn btn-info" name="showDiploma">
                                            <a href="mastersShow.php?id=<?php echo  $user['idDiploma']  ?>" style="color: #fff;">Show</a>
                                            </button>

                                        <button type="button" class="btn btn-danger" onclick="deleteRow2(this)" name="delete2">regect</button>
                                        <div>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-success" onclick="accept000()">Success</button>

                                        <button type="button" class="btn btn-info" name="showDiploma">
                                            <a href="phdShow.php?id=<?php echo  $user['idDiploma']  ?>" style="color: #fff;">Show</a>
                                            </button>

                                        <button type="button" class="btn btn-danger" onclick="deleteRow3(this)" name="delete3">regect</button>
                                        <div>
